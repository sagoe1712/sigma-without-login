...
(function($) {
    ...
    $(".departments-menu > .dropdown-toggle").click(function () {
        $(".departments-menu-dropdown").toggle();
    });

    $(".account_nav_menu > .dropdown-toggle").click(function () {
        $(".account_nav_menu > .dropdown-menu").css('left', '-70px').toggle();
        // $(".account_nav_menu > .dropdown-menu");
        var state = $( ".account_nav_menu > .dropdown-menu" ).is( ":visible" )
    ...
    $("#mob_nav_btn").click(function () {
        ...
        var state = $( "#navbarResponsive" ).is( ":visible" )
        if(state){
...
disableItem = function (button, action){
    if(action === true){
...
updateAccount = function (total) {
    $(".top_account_dropdown").html(total)
}