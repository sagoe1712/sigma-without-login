...
@section('content')
    ...
    <div id="tt-pageContent">
        <div class="five-star-container">
            ...
            <h2 ng-show="!loaded_newrestaurants" class="text-center" style="margin-bottom: 3%;">TOP RESTAURANT / VENDORS</h2>
            <h2 ng-show="loaded_newrestaurants" class="text-center" style="margin-bottom: 3%;">Restaurants</h2>
            ...
            <div class="row tt-layout-product-item restaurants_box_container ng-cloak" ng-show="loaded_newrestaurants" id="restaurants">
                    ...
                    <div class="tt-product thumbprod-center">
                        <div class="tt-image-box">
                            <a href="{{url('food/restaurant')}}/@{{ removeChars(item.name) | lowercase }}__@{{ item._id }}">
                                <span class="tt-img"><img src="{{asset('images/loader.svg')}}" data-src="@{{getImage(item.logo)}}" alt="@{{ item.name }}"></span>
                                <span class="tt-img-roll-over"><img src="{{asset('images/loader.svg')}}" data-src="@{{getImage(item.logo)}}" alt="@{{ item.name }}"></span>
                                <span class="tt-label-location">
                                <span href="{{url('food/restaurant')}}/@{{ removeChars(item.name) | lowercase }}__@{{ item._id }}"  data-tooltip="Estimated time">
                        ...
                        <div class="tt-description meal-desc">
                            ...
                            <p class="low-opacity"> Weekdays : @{{ item.openings.weekdays }} , Weekends:  @{{ item.openings.weekends }}m </p>
            ...
            <div class="row tt-layout-product-item restaurants_box_container" ng-cloak ng-show="!loaded_newrestaurants" ng-init="loadFeaturedRestaurants()">
