...
@section('content')
    ...
    <div class="take-out-container" ng-show="!loaded_newrestaurants">
...
<div  ng-show="loaded_newrestaurants">

    <div class="take-out-container">
        <div class="takeout-restaurant-container">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-12 col-md-5 modal-form-container">
                ...
                <div class="col-6 col-md-4 modal-form-container">
                    <div class="">
    ...
    <div id="tt-pageContent">
        <div class="five-star-container">
            <div class="icons-div">
{{--                <a href="#">--}}
{{--                    <i class="fa fa-arrow-left" aria-hidden="true"> &nbsp; Back to LCCI Lekki</i>--}}
{{--                </a>--}}
            </div>


            <!-- <h2 style="margin-bottom: 3%;">TOP RESTAURANT/VENDORS</h2> -->
                            ...
                            <span class="tt-img"><img src="{{asset('images/loader.svg')}}" data-src="@{{getImage(item.logo)}}" alt=""></span>
                                ...
                                <span href="{{url('food/restaurant')}}/@{{ removeChars(item.name) | lowercase }}__@{{ item._id }}"  data-tooltip="Estimated time">
                                    <div class="estimated-time-div">
                                        ...
                                        <p><span class="sigma-green">@{{ item.delivery }} minutes</span></p>
                                        </div>
                                </span>
                            </span>
                                <!-- <span class="tt-label-location">
            ...
            <div class="load-more-btn-container"  ng-show="loaded_newrestaurants">
                <button type="button" class="btn btn-default load-more-btn meals-btn" ng-click="loadMoreRestaurants()" ng-show="show_loadmore"><i class="fa fa-spinner fa-spin process_indicator" ng-show="loading_more_restaurants"></i> Load More</button>
            </div>
        </div>
    ...
    <div id="tt-pageContent"  ng-show="!loaded_newrestaurants">
        <div class="five-star-container">
