...
@section('content')
        ...
        <div class="home-container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <h1 class="animate__heartBeat">Welcome to Sigma Prime</h1>
                    <p class="animate__animated animate__slideInLeft">You matter to us, that’s
                    ...
                    <div class="start-shopping">
                        ...
                        <button type="button" class="btn btn-default search-btn home-btn3 animated-btn">
                ...
                <div class="col-lg-6 col-md-6 col-12 home-image-column .d-sm-none .d-md-block">
                    <img class="animate__animated animate__slideInRight" src="{{asset('images/home-images/image1.png')}}" width="100%" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6 about-us-first">
                <div>
                    ...
                    <h1 data-aos="flip-up" data-aos-duration="2000">About <span class="sigma-green">Sigma Prime.</span></h1>
                </div>
                ...
                <a href="{{url('catalogue')}}">
                <button type="button" class="btn btn-default search-btn home-btn animated-btn">Start Redeeming Today</button>
                </a>
            </div>
            <div class="col-12 col-md-6 col-lg-6 about-us-second">
                ...
                <div data-aos="zoom-in" data-aos-duration="2000" class="aboutusimg2">
    ...
    <div class="rewards-container">
        <div class="rewards-content-container">
            <div>
                ...
                <h1 data-aos="zoom-in" data-aos-duration="2000">Three Simple Steps To <span class="sigma-blue">Get Rewarded</span></h1>
            </div>
    ...
    <div class="sigma-pension-container">
        <div class="sigma-pen-header">
            <h1 data-aos="flip-left" data-aos-duration="2000">Sigma Prime Loyalty Program is <span class="sigma-deep-blue">one of the leading reward</span> program in Nigeria</h1>
        </div>
    ...
    <div class="redemption-catalog-session">
        <div class="redemption-contents">
            ...
            <h1 data-aos="zoom-in-down" data-aos-duration="2000" >Our Redemption Catalog</h1>
        </div>
    ...
    <div class="contact-us-container" id="contact">
        <div class="row">
            <div class="col-12 col-md-6 first-contact">
                ...
                <form class="contact-forms" id="contact-form" method="post" action="{{url('contact')}}">
                    <div class="row">
                        <div class="col-12 col-md-6">
                    ...
                    <button style="border-radius: 0px;" type="submit" class="btn btn-primary animated-btn2">Send Message</button>
                </form>
            </div>
